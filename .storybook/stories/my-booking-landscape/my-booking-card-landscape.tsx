...
} from '../my-booking/my-booking-shimmer.preset';
...
const MyBookingCardLandscape = (props: MyBookingCardProps) => {
  ...
  const renderItem = ({item}: any) => (
    <TouchableOpacity
      ...
      <View style={{width: '35%', height: '100%'}}>
        ...
        <FastImage
          style={{
            borderTopLeftRadius: getWidthTab(16.016),
            borderBottomLeftRadius: getWidthTab(16.016),
...
export default MyBookingCardLandscape;

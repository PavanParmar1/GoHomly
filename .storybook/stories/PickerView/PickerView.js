...
export default class PickerView extends Component<IProps, IState> {
  constructor(props) {
    ...
    this.state = {
      ...
      themePrimary:
        this.props.themePrimary !== '' && this.props.themePrimary !== undefined
          ? this.props.themePrimary
          : Black,
      separatorColor:
        this.props.separatorColor !== '' &&
        this.props.separatorColor !== undefined
          ? this.props.separatorColor
          : Separator,
    };
  }
  ...
  flatListItemSeparator = () => (
    <View
      style={[Styles.dashView, {backgroundColor: this.state.separatorColor}]}
    />
  );
              ...
              this.props.defaultValueStyle,
              {
                color:
                  item == this.state.selectedValue
                    ...
                    : Black,
                fontWeight: item == this.state.selectedValue ? '700' : '300',
              },
              item == this.state.selectedValue
        ...
        <Modal
          ...
          <View style={[Styles.Container]}>
            ...
            <View style={[Styles.WhiteView]}>
              <View style={[Styles.titleView, {backgroundColor: 'white'}]}>
                <Text style={[Styles.titleTxt, this.props.titleStyle]}>
                  {this.props.title}
                </Text>
              </View>
              <View>
                <FlatList
                  ...
                  style={{
                    height:
                      data.length > 5 ? this.state.viewHeight * 5 + 4 : null,
                  }}
              ...
              <View style={Styles.ButtonMainView}>
                <View style={Styles.CancelView}>
                  <TouchableOpacity onPress={() => this.onCloseModal()}>
                    <Text
                      style={[Styles.CancelText, this.props.cancelBtnStyle]}>
                      Cancel
                    </Text>
                  </TouchableOpacity>
                </View>

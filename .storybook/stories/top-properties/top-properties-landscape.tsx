...
import TopPropertiesLandscapeStyle from './top-properties-landscape-v2.presets copy';
const ShimmerPlaceHolder = createShimmerPlaceholder(LinearGradient);

function TopPropertiesLandscape(props: topPropertiesProps) {
  ...
  const styles = TopPropertiesLandscapeStyle(
    getWidth,
    getHeight,
    getWidthTab,
    windowWidth,
        ...
        {loadingState[propertyObject.Id] ? (
          <View
            style={{
              ...
              width: isTablet() ? getWidthTab(45) : getWidth(48),
              height: isTablet() ? getWidthTab(45) : getWidth(48),
            }}>
            <ActivityIndicator
              /*   style={{
                position: 'absolute',
        ...
        <View
          ...
          <TouchableOpacity
            style={{
              ...
              height: isTablet() ? getWidthTab(30) : getWidth(48),
              // width: '33%',
              // backgroundColor: 'pink',
            }}
            accessible={true}
            ...
            <View style={{height: 30, marginStart: '2%'}}>
              <Image
                style={{
                  height: isTablet() ? getHeight(5) : getHeight(15),
                  width: getWidth(5),
                  resizeMode: 'contain',
                  alignContent: 'center',
                }}
  ...
  const NoItem = ({}: {title: any; image: any}) => (
    <View style={[styles.ITEM_CONTAINER_SOLID]}>
      ...
      <View style={[styles.ITEM_INFORMATION_CONTAINER]}>
        ...
        <Divider style={{marginTop: '2%', borderColor: 'lightgrey'}} />
      ...
      style={[
        {
          ...
          shadowOffset: {width: 5.339, height: 5.339}, // Shadow offset
          shadowOpacity: 0.4,
          shadowRadius: isTablet() ? getWidthTab(5) : getWidth(5),
        },
      ]}>
      <NoItem title={''} image={''} />
    </View>
...
export default TopPropertiesLandscape;

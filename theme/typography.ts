...
export const customFontsToLoad = {
  ...
  spaceGroteskBold,
  sansItalic: require("../../assets/fonts/DMSans-Italic.ttf"),
  sansRegular: require("../../assets/fonts/DMSans-Regular.ttf"),
  sansLight: require("../../assets/fonts/DMSans-Light.ttf"),
  sansBold: require("../../assets/fonts/DMSans-Bold.ttf"),
  sansMedium: require("../../assets/fonts/DMSans-Medium.ttf"),
  sansSemiBold: require("../../assets/fonts/DMSans-SemiBold.ttf"),
  sansThin: require("../../assets/fonts/DMSans-Thin.ttf"),
